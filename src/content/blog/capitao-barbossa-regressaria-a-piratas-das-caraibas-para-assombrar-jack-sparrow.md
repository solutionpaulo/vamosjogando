---
title: 'Capitão Barbossa regressaria a Piratas das Caraíbas para assombrar Jack Sparrow'
description: 'Uma análise detalhada sobre a recente notícia de que Capitão Barbossa regressaria a Piratas das Caraíbas para assombrar Jack Sparrow, trazida pelo portal Eurogamer.pt.'
pubDate: 'Tue Sep 15 2026'
heroImage: '../../assets/capitao-barbossa-regressaria-a-piratas-das-caraibas-para-assombrar-jack-sparrow.webp'
...
De acordo com as informações compartilhadas por Eurogamer.pt, a comunidade gamer recebeu uma atualização importante: **Capitão Barbossa regressaria a Piratas das Caraíbas para assombrar Jack Sparrow**.
