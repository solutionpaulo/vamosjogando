...
ogImage: '../../assets/og-gigante-gta-vi-tera-pre-load-uma-semana-antes-do-lancamento.webp'
tags: ['Games', 'Meu PS4', 'Novidades']
---
## O que aconteceu?

De acordo com as informações compartilhadas por Meu PS4, a comunidade gamer recebeu uma atualização importante: **Gigante? GTA VI terá pré-load uma semana antes do lançamento**.
